...
const AppointmentForm = () => {
  ...
  const handleAppointment = async (e) => {
    ...
    if (
      !firstName || // Changed from firstName to firstNameInput
      !lastName || // Changed from lastName to lastNameInput
      !email ||
      !phone ||
      !nic || // Changed from nic to nicInput
      !dob || // Changed from dob to dobInput
      !gender || // Changed from gender to genderInput
      !appointmentDate ||
      !appointmentTime ||
      !doctorId ||
      !department ||
    ...
    try {
      const { data } = await axios.post(
        ...
        {
          firstName, // Use updated state
          lastName, // Use updated state
          email,
          phone,
          nic, // Use updated state
          dob: dobFormatted, // Use formatted date
          gender, // Use updated state
      ...
      resetForm(); // Call your reset function to clear the form
    } catch (error) {
      toast.error(
